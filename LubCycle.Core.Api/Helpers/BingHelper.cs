...
namespace LubCycle.Core.Helpers
{
    public class BingHelper
    {
        ...
        public async Task<Core.Api.Models.BingMaps.RootObject> GetDirectionsAsync(double lat1, double lng1, double lat2, double lng2)
        {
            ...
            var obj = JsonConvert.DeserializeObject<Core.Api.Models.BingMaps.RootObject>(str);
            return obj;
        }
        ...
        public async Task<Core.Api.Models.BingMaps.RootObject> GetDirectionsAsync(Core.Api.Models.NextBike.Place start,
            Core.Api.Models.NextBike.Place destination)
        {
